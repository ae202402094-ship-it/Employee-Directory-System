                ...
                <tr>
                    ...
                    <td class="text-right">
                        <div class="action-btns">
                            <a href="<?= BASE_URL ?>/employees/<?= $emp['id'] ?>" class="btn btn-ghost btn-xs" title="View">View</a>
                            <?php if (Auth::isHR()): ?>
                            <a href="<?= BASE_URL ?>/employees/<?= $emp['id'] ?>/edit" class="btn btn-ghost btn-xs" title="Edit">Edit</a>
                            <?php endif; ?>
                            <?php if (Auth::isAdmin()): ?>
